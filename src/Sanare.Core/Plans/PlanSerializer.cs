...
public sealed class PlanSerializer : IPlanSerializer
{
    public ExtractionPlan Read(string json)
    {
        ...
        try
        {
            ...
            {
                PlanVersion = GetInt(root, "planVersion"),
    ...
    private static AcquisitionSpec ReadAcquisition(JsonElement element)
    {
    ...
    private static NotFoundSpec ReadNotFound(JsonElement element) =>
        new(ParseEnum<PlanOperation>(GetString(element, "op")), GetString(element, "selector"));

    private static ConsentSpec ReadConsent(JsonElement element) =>
    ...
    private static PaginationSpec ReadPagination(JsonElement element) =>
        new(
    ...
    private static (PlanOperation Operation, IReadOnlyList<string> Arguments) ReadStep(JsonElement element) =>
        (
    ...
    private static PlanProvenance ReadProvenance(JsonElement element) =>
        new(
