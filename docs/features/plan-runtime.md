...
2. On a primary miss, a runtime transform failure (a transform's own data-dependent precondition not met,
   for example `regexCapture` finding no match — never an unknown operation, arity mismatch, or tier
